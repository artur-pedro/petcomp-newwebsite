...
<head>
  ...
  <link rel="stylesheet" href="css/fab-de-software.css">
  ...
  <main>
    <div>
      <div class="title-section">
        ...
        <div class="acess-title">
            <a href="#" class="acess-link"> Pagina Inicial -> </a>
            <a href="#" class="acess-link"> Projetos -> </a>
            <h4> Fáb.Software </h4>
        </div>

      </div>

      <div class="text-fab-software">
      ...
      <div class="sites-cards">
        ...
        <div class="software-card">
          ...
          <div class="text">
            <h2><a target="_blank" href="https://petcompufma.org/cocom/">COCOM</a></h2>
            <div class="wrapper-labels">
              <div class="label php">PHP</div>
              <div class="label html">HTML</div>
              <div class="label css">CSS</div>
        ...
        <div class="software-card">
          ...
          <div class="text">
            <h2><a target="_blank" href="https://petcompufma.org/eacomp/">EAComp</a></h2>
            <div class="wrapper-labels">
              <div class="label html">HTML</div>
              <div class="label css">CSS</div>
              <div class="label javascript">JavaScript</div>
